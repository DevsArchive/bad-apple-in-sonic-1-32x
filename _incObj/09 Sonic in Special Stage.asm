...
Obj09_Get1Up:
		...
		move.w	#sfx_Cash,d0
		jsr	PlaySound_Special	; play extra life music
		moveq	#0,d4
		rts	
; ===========================================================================
...
Obj09_BumpSnd:
		...
		jmp	PlaySound_Special	; play bumper sound
; ===========================================================================
...
Obj09_GOAL:
		...
		jsr	PlaySound_Special	; play "GOAL" sound
		rts	
; ===========================================================================
...
Obj09_UPsnd:
		...
		jmp	PlaySound_Special	; play up/down sound
; ===========================================================================
...
Obj09_RevStage:
		...
		move.w	#sfx_SSItem,d0
		jmp	PlaySound_Special	; play sound
; ===========================================================================
...
Obj09_GlassSnd:
		...
		jmp	PlaySound_Special	; play glass block sound
; ===========================================================================
