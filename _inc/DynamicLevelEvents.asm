...
DLE_LZ3:
		...
		cmpi.w	#$1718,(v_layout+$50C).w	; MJ: is current layout already set to wall version?
		beq.s	loc_6F28			; MJ: if so, branch to skip
		move.w	#$1718,(v_layout+$50C).w	; MJ: Set wall version of act 3's layout to be read
