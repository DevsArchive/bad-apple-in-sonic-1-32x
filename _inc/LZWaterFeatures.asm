...
DynWater_LZ3:
		...
		move.w	#$F8F9,(v_layout+$50C).w	; MJ: Set normal version of act 3's layout to be read
		move.b	#1,(v_wtr_routine).w ; use second routine next
...
@chksonic:
		...
		jsr	PlaySound_Special	; play rushing water sound (only every $40 frames)
...
LZWaterSlides:
		...
		lea	(v_layout).w,a2		; MJ: Load address of layout
...
loc_3F9A:
		...
		bne.s	locret_3FBE
		move.w	#sfx_Waterfall,d0
		jsr	PlaySound_Special	; play water sound
